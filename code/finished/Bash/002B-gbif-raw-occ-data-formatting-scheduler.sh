...
#SBATCH --output=/blue/guralnick/millerjared/PlantSweepeR/logs/002-data-formatting/gbif-raw-data-formatting%j.log                  # Standard output and error log
...
Rscript --vanilla /blue/guralnick/millerjared/PlantSweepeR/code/finished/R/002B-gbif-raw-occ-data-formatting.R
done