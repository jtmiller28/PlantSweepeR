...
#SBATCH --output=/blue/guralnick/millerjared/PlantSweepeR/logs/004-delimit-to-North-America/ncbi-check_%A-%a.out                 # Standard output and error log
...
Rscript --vanilla /blue/guralnick/millerjared/PlantSweepeR/code/finished/R/004B-ncbi-north-america-delimitation.R
